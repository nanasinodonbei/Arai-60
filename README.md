...
### Ph1
1.**ブランチの作成**
  - 課題を始める前に作業用のブランチ、フォルダ、ファイル群を作成する
  - `main`（または `master`）で直接作業せず、専用のブランチに自動で切り替える
  - **[TBD]**　スクリプト作成するか

2.**課題の取り組み（step1 〜 step3）**
  - マニュアルに従ってコードを作成

3.**PR作成**
  - 課題完了後に実行し、コードを GitHub へプッシュして PR（プルリクエスト）を作成する

4.**Discord にレビュー依頼を投稿**
  - レビュー用チャンネルに PR のリンク等を共有してレビューを依頼する

5.**レビューコメントへの対応**
  - 投稿されたフィードバックを確認し、修正を行う

6.**PR のマージ**
  - レビュー完了後、`main` ブランチにコードを統合する  

### Ph2
  ・忘却曲線/パターンプラクティス/アルゴリズムに関する情報の深掘り
  - **[TBD]**　順序立てる 
...
[英語が話せるようになるには　始めから丁寧に　第二言語習得研究に基づく実践トレーニング](https://www.sunafuki.com/entry/how-to-speak#%E8%87%AA%E5%8B%95%E5%8C%96%E3%81%95%E3%82%8C%E3%81%9F%E9%A1%95%E5%9C%A8%E7%9F%A5%E8%AD%98%E3%81%A8%E3%81%AF)
